                      ...
                      <div class="select_border">
                        ...
                        <option>赛事</option>
                            ...
                            <tr>
                                ...
                                <td class="">
                                    <input type="text" name="name" class="input-text lh30" size="15">~<input type="text"
                                                                                                             name="name"
                      ...
                      <div class="select_border">
                        ...
                        <option>体育赛事门票</option>
                                ...
                                <tr>
                                    ...
                                    <td class="">
                                        项目结束后&nbsp;&nbsp;<input type="text" name="name" class="input-text lh30"
                                                                size="10">天
                                    </td>
                                </tr>
                                <tr>
